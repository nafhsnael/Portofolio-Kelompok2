    ...
    >
      <div style={{ maxWidth: "860px", margin: "0 auto" }}>
        ...
        <p style={{ lineHeight: 1.8, fontSize: "1.05rem", marginBottom: "20px" }}>
          ...
          When I am not focused on my studies, you can usually find me exploring local coffee shops, practicing photography, which helps me stay refreshed and inspired. I am always open to new opportunities, networking, and experiences that can help me grow both personally and professionally.
        </p>
        <p style={{ lineHeight: 1.8, fontSize: "1.05rem" }}>
          Throughout my studies, I have developed a strong technical foundation in web development, specifically in HTML, CSS, JavaScript, and React. I am a lifelong learner who consistently strives to expand my knowledge and stay updated with the latest industry trends every single day. I believe that being a student is not just about earning a degree, but about building an adaptable mindset...
        </p>
      </div>
    </section>
  );
